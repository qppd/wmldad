...
| **IDE** | PlatformIO (VS Code) | Latest | Best dependency management, CLI build, library auto-install |
...
| Tool | Purpose |
|------|---------|
| **PlatformIO** | Build, upload, and debug ESP32 firmware |
| **VS Code** | Primary IDE for firmware + backend |
