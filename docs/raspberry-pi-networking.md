...
> 📸 **Screenshot Placeholder:** *Terminal showing `hostname` command output*
...
*Last updated: July 2026 | Tested on Raspberry Pi OS Bookworm (64-bit) | Compatible with Pi 3B+/4/5*